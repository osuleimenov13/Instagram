...
class IGFeedPostHeaderTableViewCell: UITableViewCell {
    ...
    private let profilePhotoImageView: UIImageView = {
        ...
        imageView.layer.masksToBounds = true // to clip it to circle lately
    ...
    private let usernameLabel: UILabel = {
        let label = UILabel()
        label.textColor = .label // to make sure the color is appropriate in dark mode, .label is cementic color which adjusts based on dark mode and light mode
